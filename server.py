...
_env_map = {"jira_url": "JIRA_BASE_URL", "jira_email": "JIRA_EMAIL", "jira_token": "JIRA_API_TOKEN", "jira_project": "JIRA_DEFAULT_PROJECT", "azure_endpoint": "AZURE_ENDPOINT", "azure_key": "AZURE_API_KEY", "azure_deployment": "AZURE_DEPLOYMENT"}
...
async def handle_start(request):
    ...
    audio_page_url = f"{base_url}/audio-page?session={session_id}" if USE_OUTPUT_MEDIA else None
...
async def handle_settings_save(request):
    ...
    for key in ["jira_url", "jira_email", "jira_token", "jira_project", "jira_sprint", "azure_endpoint", "azure_key", "azure_deployment"]:
